...
class _LargeFileMain extends State<LargeFileMain> {
  ...
  void initState() {
    super.initState();
    _editingController = new TextEditingController(text: 'http://192.168.0.26:4000/ocrpreimages/hi.jpg');
  }

  Future<void> downloadFile(String imgname) async {
    Dio dio = Dio();
    try {
      var serverurl = "http://192.168.0.26:4000/ocrpreimages/"+imgname;
      var dir = await getApplicationDocumentsDirectory();
      await dio.download(serverurl, '${dir.path}/'+imgname,
          onReceiveProgress: (rec, total) {
            print('Rec: $rec , Total: $total');
            file = '${dir.path}/'+imgname;
            setState(() {
              downloading = true;
